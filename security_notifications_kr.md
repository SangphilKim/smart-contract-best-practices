...
- [Ethereum Blog](https://blog.ethereum.org/): 공식 이더리움 블로그
  - [Ethereum Blog - Security only](https://blog.ethereum.org/category/security/): *Security* 태그가 붙은 모든 블로그 글들
- [Ethereum Gitter](https://gitter.im/orgs/ethereum/rooms) 대화방들
...
- **Vitalik Buterin**: [트위터](https://twitter.com/vitalikbuterin), [깃허브](https://github.com/vbuterin), [Reddit](https://www.reddit.com/user/vbuterin), [이더리움 블로그](https://blog.ethereum.org/author/vitalik-buterin/)
